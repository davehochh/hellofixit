(function($){
    Drupal.behaviors.md_springfield = {
        attach: function () {

////////////////////////////// Call confirmation popup when click Reset Settings //////////////////////////////////////

            /*var events = $('#edit-reset').data('events'); // Get the jQuery events.
            $('#edit-reset').unbind('click'); // Remove the click events.
            $('#edit-reset').click(function () {
                if (confirm('Are you sure you want to reset all theme setting to default?')) {
...
//////////////////////////////////////////////////// Add Class To Default Submit /////////////////////////////////////////////////////
		...
		if ($('#edit-map-marker-image-enable').is(':checked')) {
			$('#edit-map-marker-image-media-wrapper').show();
		} else {
			$('#edit-map-marker-image-media-wrapper').hide();
		}
    })
})(jQuery);
    ////////////////////////////////////////////////////// Add more content ////////////////////////////////////////////////
    (function($){
        ...
        jQuery(document).ready(function(){
			...
			data["gallery_image_slide_preview"] = [];
            $("#gallery_image_slide_preview").find("li.sortable-item").each(function(){
                data["gallery_image_slide_preview"].push(parseInt($(this).attr("data-num"),10));
            });
            if(data["gallery_image_slide_preview"].length <=1 ) {
                $("#gallery_image_slide_preview").find(".md-remove").hide();
            }
			data["hd_content_slide_preview"] = [];
            $("#hd_content_slide_preview").find("li.sortable-item").each(function(){
                data["hd_content_slide_preview"].push(parseInt($(this).attr("data-num"),10));
            });
            if(data["hd_content_slide_preview"].length <=1 ) {
                $("#hd_content_slide_preview").find(".md-remove").hide();
            }
...
/////////////////////////////////////////////////// Icon Picker ////////////////////////////////////////////////////////
			...
			$('#edit-map-marker-image-enable').bind('change', function() {
				if ($(this).is(':checked')) {
					$('#edit-map-marker-image-media-wrapper').show();
				} else {
					$('#edit-map-marker-image-media-wrapper').hide();
