...
$(document).ready(function() {
	...
	$('.mobile-nav').children('ul').addClass('slimmenu');
...
function service_height_init(){
        ...
        if ($(window).width() >= 767) {
            ...
            if (service_max_height > $(".service-item").width() * 0.9) {
                $(".service-item").height(service_max_height);
            }
            else {
                $(".service-item").height($(".service-item").width() * 0.9);
            }
        }
        
        var service_descr_offset;
        var service_intro_offset;
        $(".service-item").find(".service-descr").each(function(){
...
jQuery(window).load(function() {
	...
	===================================================================*/       
	jQuery('.arrow-block a[href^="#"],.section-scroll a[href^="#"],.slider-teaser a[href^="#"],.footer-menu a[href^="#"], a[href^="#"]').on('click', function(e) {
    e.preventDefault();
